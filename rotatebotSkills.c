...
#pragma config(Motor,  port3,           right,         tmotorVex393TurboSpeed_MC29, openLoop, encoderPort, I2C_2)
#pragma config(Motor,  port4,           lift,          tmotorVex393TurboSpeed_MC29, openLoop, encoderPort, I2C_3)
